    ...
    <header className="relative z-10 flex items-center justify-between px-4 py-3.5 md:px-8">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="grid size-9 place-items-center rounded-full bg-[var(--surface-elevated)] text-[15px] leading-none ring-1 ring-slate-200/80 transition-all duration-200 hover:-translate-y-0.5"
        >
